...
save_stem=$(/opt/conda/envs/diffusionmritoolkit/bin/python ${scripts_dir}/ODTB-misc_make_design_delta.py $groups_file ${reg_output_dir}/vba_randomise/ ${reg_output_dir} $vol)
