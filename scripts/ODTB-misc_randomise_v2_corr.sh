...
save_stem=$(/opt/conda/envs/diffusionmritoolkit/bin/python ${scripts_dir}/ODTB-misc_make_design_corr.py $groups_file ${reg_output_dir}/vba_randomise/${vol}_)
...
while IFS=',' read -r subject group timepoint filename corrdat; do
